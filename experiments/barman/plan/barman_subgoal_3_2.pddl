...
(fill-shot shot4 ingredient1 left right dispenser1) ; Prepare first ingredient
(pour-shot-to-clean-shaker shot4 ingredient1 shaker1 left l0 l1)
(clean-shot shot4 ingredient1 left right) ; clean shot4.
...
(leave left shot4)
(grasp right shaker1)
(shake cocktail2 ingredient1 ingredient2 shaker1 right left) ; cocktail-part1 is first parameter, and then cockail-part2 comes as next parameter in shake action.
