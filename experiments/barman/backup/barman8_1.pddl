...
(define (problem prob) (:domain barman)
  ...
  (:init 
    (ontable shaker1) 
    (ontable shot1) (ontable shot2) (ontable shot3) (ontable shot4) (ontable shot5) (ontable shot6) (ontable shot7) (ontable shot8) (ontable shot9)
    (dispenses dispenser1 ingredient1) 
    (dispenses dispenser2 ingredient2) 
    (dispenses dispenser3 ingredient3) 
    (clean shaker1) (clean shot1) (clean shot2) (clean shot3) (clean shot4) (clean shot5) (clean shot6) (clean shot7) (clean shot8) (clean shot9)
    (empty shaker1) (empty shot1) (empty shot2) (empty shot3) (empty shot4) (empty shot5) (empty shot6) (empty shot7) (empty shot8) (empty shot9)
  ...
  (:goal 
    (and (contains shot1 cocktail1) (contains shot2 cocktail2) (contains shot3 cocktail3) (contains shot4 cocktail4) (contains shot5 cocktail5) (contains shot6 cocktail6) (contains shot7 cocktail7) (contains shot8 cocktail8))))
