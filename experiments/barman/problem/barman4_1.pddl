...
(define (problem prob) (:domain barman)
  ...
  (:init 
    ...
    (clean shaker1) (clean shot1) (clean shot2) (clean shot3) (clean shot4) (clean shot5) 
    (empty shaker1) (empty shot1) (empty shot2) (empty shot3) (empty shot4) (empty shot5) 
  ...
  (:goal 
    (and (contains shot1 cocktail1) (contains shot2 cocktail2) (contains shot3 cocktail3) (contains shot4 cocktail4))))
